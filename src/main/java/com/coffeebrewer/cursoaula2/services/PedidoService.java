...
import com.coffeebrewer.cursoaula2.domain.*;
import com.coffeebrewer.cursoaula2.domain.enums.EstadoPagamento;
import com.coffeebrewer.cursoaula2.repositories.ItemPedidoRepository;
import com.coffeebrewer.cursoaula2.repositories.PagamentoRepository;
...
public class PedidoService {
    ...
    public Pedido insert(Pedido obj){
        ...
        for (ItemPedido ip : obj.getItens()) {
            ip.setDesconto(0.00);
            ip.setPreco(productService.find(ip.getProduct().getId()).getPreco());
            ip.setPedido(obj);
        }
